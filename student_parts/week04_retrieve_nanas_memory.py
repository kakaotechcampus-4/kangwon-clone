    ...
    return [
        *week03_prompt_parts(),
        ...
        (
            ...
            "   - '오늘 일정 뭐 있어', '이번 주 할 일 보여줘', '알림 설정해둔 거 있나' 등\n"
            "     정식으로 구조화되어 등록된 일정/할 일/알림을 물을 때 사용한다.\n"
            "\n"
            ...
            "- 검색 결과가 부족하거나 사용자가 언급한 내용이 안 보이면, top_k를 조금 더\n"
            "  크게 해서 같은 tool을 다시 호출해보고, 그래도 없으면 없다고 솔직히 답한다."
        ),
    ]
