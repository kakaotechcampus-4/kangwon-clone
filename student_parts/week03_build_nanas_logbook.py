...
WEEK03_TOOL_CALL_PROMPT = "\n".join([
    "일정, 할 일, 알림을 새로 생성하는 요청이 오면, 1~2주차의 생성 관련 tool은 메모리에만 저장되고 SQLite에는 남지 않으니 절대 호출하지 마. 대신 요청을 personal_schedule/group_schedule/todo/reminder/unknown 중 하나로 분류하고, save_structured_request tool을 직접 호출해서 필요한 필드를 채워 저장해.",
